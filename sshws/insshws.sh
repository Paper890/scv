...
wget -O /usr/local/bin/ws-dropbear https://raw.githubusercontent.com/Paper890/scv/main/sshws/dropbear-ws.py
wget -O /usr/local/bin/ws-stunnel https://raw.githubusercontent.com/Paper890/scv/main/sshws/ws-stunnel
...
wget -O /etc/systemd/system/ws-dropbear.service https://raw.githubusercontent.com/Paper890/scv/main/sshws/service-wsdropbear && chmod +x /etc/systemd/system/ws-dropbear.service

#System SSL/TLS Websocket-SSH Python
wget -O /etc/systemd/system/ws-stunnel.service https://raw.githubusercontent.com/Paper890/scv/main/sshws/ws-stunnel.service && chmod +x /etc/systemd/system/ws-stunnel.service
