...
echo -e "${YELLOW}"
echo -e "${YELLOW}   ╔ ——————————————————————————————————— ╗${NC}"
echo -e "${ORANGE}           MENU TROJAN${NC}"
echo -e "${YELLOW}   ╚ ——————————————————————————————————— ╝${NC}"
echo -e "${GREEN}    1. Create Account Trojan Go "
echo -e "${GREEN}    2. Trial Account Trojan Go "
echo -e "${GREEN}    3. Extending Account Trojan Go Active Life "
echo -e "${GREEN}    4. Delete Account Trojan Go "
echo -e "${GREEN}    5. Check User Login Trojan Go"
echo -e "${YELLOW}   ╚ ——————————————————————————————————— ╝${NC}"
